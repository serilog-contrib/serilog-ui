    ...
    : IRequirePathTool
{
        ...
        Action<OutputType, string> customLogger = null)
    {
        using var process = ProcessTasks.StartProcess(YarnPath,
            ...
            logInvocation, customLogger ?? YarnLogger);
    ...
    ///   </ul>
    /// </remarks>
    public static IEnumerable<(YarnInstallSettings Settings, IReadOnlyCollection<Output> Output)> YarnInstall(
        CombinatorialConfigure<YarnInstallSettings> configurator,
    ...
    ///   </ul>
    /// </remarks>
    public static IEnumerable<(YarnRunSettings Settings, IReadOnlyCollection<Output> Output)> YarnRun(
        CombinatorialConfigure<YarnRunSettings> configurator,
        int degreeOfParallelism = 1,
        bool completeOnFailure = false)
    {
    ...
    ///   </ul>
    /// </remarks>
    public static IEnumerable<(YarnGetConfigSettings Settings, IReadOnlyCollection<Output> Output)> YarnGetConfig(
        CombinatorialConfigure<YarnGetConfigSettings> configurator,
        int degreeOfParallelism = 1,
        bool completeOnFailure = false)
    {
    ...
    ///   </ul>
    /// </remarks>
    public static IEnumerable<(YarnSetConfigSettings Settings, IReadOnlyCollection<Output> Output)> YarnSetConfig(
        CombinatorialConfigure<YarnSetConfigSettings> configurator,
        int degreeOfParallelism = 1,
        bool completeOnFailure = false)
    {
...
public partial class YarnInstallSettings : ToolSettings
{
    ...
    public override Action<OutputType, string> ProcessLogger => base.ProcessLogger ?? YarnTasks.YarnLogger;
