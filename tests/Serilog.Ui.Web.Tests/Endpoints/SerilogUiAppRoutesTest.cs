    ...
    public class SerilogUiAppRoutesTest
    {
        ...
        public async Task It_gets_app_home()
        {
            ...
            bodyWrite.Should().Be(
                ...
                "disabledSortOnKeys%22%3A%5B%5D%2C%22hideBrand%22%3Afalse%2C%22homeUrl%22%3A%22home-url" +
                "%22%2C%22routePrefix%22%3A%22test%22%7D';</script><div>body-test</div></body></html>"
                );
        }
