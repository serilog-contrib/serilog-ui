...
{
    public class IntegrationSearchTests<DatabaseInstance, T, T1> : IClassFixture<DatabaseInstance>, IIntegrationSearchTests
        ...
        where T1 : TestcontainerDatabaseConfiguration, new()
    {
        ...
        protected IntegrationSearchTests(DatabaseInstance<T, T1> instance)
        {
