    ...
    <>
      <Fieldset component='form' legend='Basic Authentication' mb='md'>
        <Alert
          ...
          mt='xs'
          mb='md'>
          Basic authentication should be used only for testing and development
          purposes.
          <br />
          Using Basic authentication is highly discouraged in production
          environments!
        </Alert>
        <TextInput
          placeholder='admin'
      ...
      <Group
        display='flex'
        justify='right'
        aria-label='Basic modal button group'>
        <Button
