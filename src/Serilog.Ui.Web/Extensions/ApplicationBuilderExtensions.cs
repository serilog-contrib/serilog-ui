...
public static class ApplicationBuilderExtensions
{
    ...
    public static IApplicationBuilder UseSerilogUi(this IApplicationBuilder applicationBuilder, Action<UiOptions>? options = null)
    {
        ...
        ProvidersOptions providerOptions = applicationBuilder.ApplicationServices.GetRequiredService<ProvidersOptions>();
        UiOptions uiOptions = new UiOptions(providerOptions);
